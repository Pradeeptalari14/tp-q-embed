# 📐 Q-Embed (Quantized Embedding)

> Utility for initializing 1-bit binary and Int8 quantized embedding models for memory optimization.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/q-embed/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-q-embed.git
cd tp-q-embed
```
...
```bash
kubectl port-forward deployment/tp-q-embed 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── quantized_embedding.py     # Main configuration file
```
...
---
*Generated by [Q-Embed (Quantized Embedding) Studio](https://pradeeptalari14.github.io/portfolio/tools/q-embed/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
